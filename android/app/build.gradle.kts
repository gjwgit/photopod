...
android {
    namespace = "com.togaware.photopod"
    ...
    defaultConfig {
        ...
        applicationId = "com.togaware.photopod"
        ...
        manifestPlaceholders.putAll(mapOf(
            "appAuthRedirectScheme" to "com.togaware.photopod",
            "oidcRedirectScheme" to "com.togaware.photopod"
        ))
    }
